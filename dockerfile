...
RUN apt-get clean
RUN apt-get update
RUN apt-get -y install make gcc python3 unzip python3-pip curl install ffmpeg python3 python3-pip unzip rsync python3-distutils sudo git tar build-essential ssh aria2 screen  make gcc  vim wget curl proxychains locales
